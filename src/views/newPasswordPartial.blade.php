  ...
  <div class="form-group">
      <div class="input-group">
          ...
          {{ Form::text(Config::get('login::usuario.campo'), $email, ['class' => 'form-control', 'disabled' => true]) }}
      </div>
  </div>
  <div class="form-group">
      <div class="input-group">
          ...
          <input type="password" class="form-control" name="{{ Config::get('login::password.campo') }}"
              ...
              placeholder="Nueva {{ Config::get('login::password.titulo') }}" data-bv-notempty="true"
  ...
  <div class="form-group">
      <div class="input-group">
          ...
          <input type="password" class="form-control" name="{{ Config::get('login::password.campo') }}2"
              id="{{ Config::get('login::password.campo') }}2"
              placeholder="Repetir {{ Config::get('login::password.titulo') }}" data-bv-notempty="true"
              data-bv-notempty-message="{{ Config::get('login::password.titulo') . ' es un campo requerido' }}"
              data-bv-identical="true" data-bv-identical-field="{{ Config::get('login::password.campo') }}"
