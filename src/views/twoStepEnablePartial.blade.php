...
<div class="text-center">{{ HTML::image($qr, 'Codigo', ['width' => '150']) }}</div>

<p>Después de escanear el código de barra, ingresa el código de verificación de seis dígitos que generó la aplicación
    Autenticador de Google.</p>
{{ Form::text('txCodigo', '', ['id' => 'txCodigo', 'class' => 'form-control']) }}
